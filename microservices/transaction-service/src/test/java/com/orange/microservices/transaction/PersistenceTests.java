...
public class PersistenceTests {
    ...
    public void setupDb() {
        ...
        TransactionEntity entity = new TransactionEntity(1, TransactionType.IBAN_TO_IBAN, "i", "c", "n", "d",1);
    ...
    @Test
    public void create() {
        TransactionEntity newEntity = new TransactionEntity(2, TransactionType.IBAN_TO_IBAN, "i", "c", "n", "d",2);
    ...
    public void duplicateError() {
        TransactionEntity entity = new TransactionEntity(savedEntity.getTransactionId(), TransactionType.IBAN_TO_IBAN, "i", "c", "n", "d",1);
